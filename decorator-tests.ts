...
if (!(Symbol.metadata in Function)) {
	Object.defineProperty((Function as any).prototype, Symbol.metadata, {
		value: null,
	});
}
...
const tests: Record<string, () => Promise<void> | void> = {
	...
	"Class decorators: Basic statement": () => {
		...
		const dec =
			(name: string) =>
			(cls: { new (): Foo }, ctx: ClassDecoratorContext) => {
	...
	"Class decorators: Basic expression: Anonymous": () => {
		...
		const dec =
			(name: string) =>
			(cls: { new (): unknown }, ctx: ClassDecoratorContext) => {
				assertEq(() => typeof cls, "function");
				assertEq(() => cls.name, name);
				assertEq(() => ctx.kind, "class");
				assertEq(() => ctx.name, name);
	...
	"Class decorators: Binding initialization (class statement)": () => {
		...
		class Foo {
			...
			set setter(x: { foo: typeof Foo | null }) {
				x.foo = Foo;
			}
			static set setter(x: { foo: typeof Foo | null }) {
				x.foo = Foo;
			}
		...
		assertEq(
			() => ((obj = { foo: null }), (old.setter = obj), obj.foo),
			Bar,
		);
		assertEq(
			() => ((obj = { foo: null }), (foo.setter = obj), obj.foo),
			Bar,
		);
	...
	"Getter decorators: Shim (instance getter)": () => {
		...
		assertEq(
			() => Object.getOwnPropertyDescriptor(Foo.prototype, "foo")!.get,
			bar!,
		);
		assertEq(() => new Foo().foo, 124);
	},
	...
	"Getter decorators: Return null (instance getter)": () => {
		assertThrows(() => {
			const dec = (
				fn: (this: Foo) => undefined,
				ctx: ClassGetterDecoratorContext,
			): any => {
				return null;
			};
			class Foo {
				@dec get foo(): undefined {
					return;
				}
			}
		}, TypeError);
	...
	"Getter decorators: Return null (static getter)": () => {
		assertThrows(() => {
			const dec = (
				fn: (this: typeof Foo) => undefined,
				ctx: ClassGetterDecoratorContext,
			): any => {
				return null;
			};
			class Foo {
				@dec static get foo(): undefined {
					return;
				}
			}
		}, TypeError);
	...
	"Getter decorators: Extra initializer (static getter)": () => {
		...
		class Foo {
			@dec @dec static get foo(): undefined {
				return;
			}
		}
		assertEq(() => got.this, Foo);
	...
	"Setter decorators: Basic (instance setter)": () => {
		const dec =
			(key: PropertyKey, name: string) =>
			(
				fn: (this: Foo, x: number) => void,
				ctx: ClassSetterDecoratorContext,
			) => {
				assertEq(() => typeof fn, "function");
				assertEq(() => fn.name, name);
		...
		class Foo {
			bar = 0;
			@dec("foo", "set foo") set foo(x: number) {
				this.bar = x;
			}
			@dec(bar, "set [bar]") set [bar](x: number) {
				this.bar = x;
			}
			@dec(baz, "set ") set [baz](x: number) {
				this.bar = x;
			}
		}
		var obj = new Foo();
	...
	"Setter decorators: Basic (static setter)": () => {
		const dec =
			(key: PropertyKey, name: string) =>
			(
				fn: (this: typeof Foo, x: number) => void,
				ctx: ClassSetterDecoratorContext,
			) => {
				assertEq(() => typeof fn, "function");
				assertEq(() => fn.name, name);
		...
		class Foo {
			static bar = 0;
			@dec("foo", "set foo") static set foo(x: number) {
				this.bar = x;
			}
			@dec(bar, "set [bar]") static set [bar](x: number) {
				this.bar = x;
			}
			@dec(baz, "set ") static set [baz](x: number) {
				this.bar = x;
			}
		}
		Foo.foo = 321;
	...
	"Setter decorators: Shim (instance setter)": () => {
		...
		assertEq(
			() => Object.getOwnPropertyDescriptor(Foo.prototype, "foo")!.set,
			bar!,
		);
		var obj = new Foo();
		obj.foo = 321;
	...
	"Setter decorators: Order (static setter)": () => {
		...
		log.push(0);
		class Foo {
			@dec1 @dec2 static set foo(x: number) {
				log.push(6);
			}
		}
		log.push(3);
	...
	"Setter decorators: Return null (instance setter)": () => {
		assertThrows(() => {
			const dec = (
				fn: (this: Foo, x: undefined) => void,
				ctx: ClassSetterDecoratorContext,
			): any => {
				return null;
			};
			class Foo {
				@dec set foo(x: undefined) {}
			}
		}, TypeError);
	},
	"Setter decorators: Return null (static setter)": () => {
		assertThrows(() => {
			const dec = (
				fn: (this: typeof Foo, x: undefined) => void,
				ctx: ClassSetterDecoratorContext,
			): any => {
				return null;
			};
			class Foo {
				@dec static set foo(x: undefined) {}
			}
		}, TypeError);
	},
	...
	"Setter decorators: Extra initializer (static setter)": () => {
		...
		class Foo {
			@dec @dec static set foo(x: undefined) {}
		}
		assertEq(() => got.this, Foo);
		assertEq(() => got.args.length, 0);
	},
	...
	"Auto-accessor decorators: Basic (instance auto-accessor)": () => {
		const dec =
			(key: PropertyKey, getName: string, setName: string) =>
			(
				target: ClassAccessorDecoratorTarget<Foo, number>,
	...
	"Auto-accessor decorators: Basic (static auto-accessor)": () => {
		const dec =
			(key: PropertyKey, getName: string, setName: string) =>
			(
				target: ClassAccessorDecoratorTarget<typeof Foo, number>,
				ctx: ClassAccessorDecoratorContext,
			) => {
				assertEq(() => typeof target.get, "function");
				assertEq(() => typeof target.set, "function");
	...
	"Auto-accessor decorators: Shim (instance auto-accessor)": () => {
		...
		const dec = (
			target: ClassAccessorDecoratorTarget<Foo, number>,
			ctx: ClassAccessorDecoratorContext,
		): ClassAccessorDecoratorResult<Foo, number> => {
	...
	"Auto-accessor decorators: Shim (static auto-accessor)": () => {
		...
		const dec = (
			target: ClassAccessorDecoratorTarget<typeof Foo, number>,
			ctx: ClassAccessorDecoratorContext,
		): ClassAccessorDecoratorResult<typeof Foo, number> => {
	...
	"Auto-accessor decorators: Return null (static auto-accessor)": () => {
		assertThrows(() => {
			...
			class Foo {
				@dec static accessor foo: undefined;
			}
		}, TypeError);
	},
	...
	"Auto-accessor decorators: Extra initializer (instance auto-accessor)":
		() => {
			...
			class Foo {
				@dec @dec accessor foo: undefined;
			}
			assertEq(() => got, undefined);
			const instance = new Foo();
			assertEq(() => got.this, instance);
	...
	"Auto-accessor decorators: Extra initializer (static auto-accessor)":
		() => {
			...
			class Foo {
				@dec @dec static accessor foo: undefined;
			}
			assertEq(() => got.this, Foo);
			assertEq(() => got.args.length, 0);
		},
	...
	"Decorator list evaluation: Computed names (class statement)": () => {
		...
		class Foo extends (foo(1), Object) {
			...
			@foo(10) get [computed.getter](): undefined {
				return;
			}
			@foo(12) static get [computed.getter](): undefined {
				return;
			}
	...
	'Decorator list evaluation: "this" (class statement)': () => {
		...
		function wrapper(this: typeof ctx) {
			...
			class Foo extends (assertEq(() => this.foo(1), undefined), Object) {
				...
				static get getter(): undefined {
					return;
				}

				@(assertEq(() => this.foo(8), undefined), dummy) set setter(
					x: undefined,
				) {}
				@(assertEq(() => this.foo(9), undefined), dummy)
				static set setter(x: undefined) {}

				@(assertEq(() => this.foo(10), undefined), dummy)
				accessor accessor: undefined;
				@(assertEq(() => this.foo(11), undefined), dummy)
				static accessor accessor: undefined;
			}
		}
	...
	'Decorator list evaluation: "await" (class statement)': async () => {
		...
		async function wrapper() {
			...
			class Foo extends (log.push(await Promise.resolve(1)), Object) {
				...
				@(log.push(await Promise.resolve(8)), dummy) set setter(
					x: undefined,
				) {}
				@(log.push(await Promise.resolve(9)), dummy) static set setter(
					x: undefined,
				) {}
		...
		class Dummy {
			...
			static {
				...
				class Foo extends (dummy.#foo(1), Object) {
					...
					@(dummy.#foo(6)) get getter(): undefined {
						return;
					}
					@(dummy.#foo(7)) static get getter(): undefined {
						return;
					}
		...
		class Dummy {
			...
			static {
				...
				class Foo {
					...
					@capture(() => new Foo().#foo + 5) get getter(): undefined {
						return;
					}
					...
					@capture(() => new Foo().#foo + 7) set setter(
						x: undefined,
					) {}
					@capture(() => new Foo().#foo + 8) static set setter(
						x: undefined,
					) {}
	...
	"Decorator list evaluation: Class binding (class statement)": () => {
		...
		class Foo {
			...
			@capture(() => Foo) get getter(): undefined {
				return;
			}
			@capture(() => Foo) static get getter(): undefined {
				return;
			}
	...
	"Decorator metadata: class statement": () => {
		...
		assertEq(
			() => order(bar),
			"0,1,2,3,11,12,13,14,4,5,6,7,15,16,17,18,8,19,9,20,10,21",
		);
		...
		assertEq(
			() => JSON.stringify(FooOneDec[Symbol.metadata]!),
			JSON.stringify({ x: 22 }),
		);
		assertEq(
			() => JSON.stringify(BarOneDec[Symbol.metadata]!),
			JSON.stringify({ y: 23 }),
		);
		assertEq(
			() => Object.getPrototypeOf(BarOneDec[Symbol.metadata]!),
			FooOneDec[Symbol.metadata]!,
		);
	},
	...
	"Initializer order (public members, class statement)": () => {
		...
		const classDec1 = (
			cls: { new (): Foo },
			ctxClass: ClassDecoratorContext,
		) => {
			log.push("c2");
		...
		const methodDec1 = (
			fn: (this: Foo) => void,
			ctxMethod: ClassMethodDecoratorContext,
		) => {
			log.push("m2");
		...
		const staticMethodDec1 = (
			fn: (this: Foo) => void,
			ctxStaticMethod: ClassMethodDecoratorContext,
		) => {
			log.push("M2");
			if (
				!assertEq(
					() => typeof ctxStaticMethod.addInitializer,
					"function",
				)
			)
				return;
		...
		const staticFieldDec1 = (
			...
			if (
				!assertEq(
					() => typeof ctxStaticField.addInitializer,
					"function",
				)
			)
				return;
		...
		const getterDec1 = (
			fn: (this: Foo) => undefined,
			ctxGetter: ClassGetterDecoratorContext,
		) => {
			log.push("g2");
		...
		const staticGetterDec1 = (
			fn: (this: Foo) => undefined,
			ctxStaticGetter: ClassGetterDecoratorContext,
		) => {
			log.push("G2");
			if (
				!assertEq(
					() => typeof ctxStaticGetter.addInitializer,
					"function",
				)
			)
				return;
		...
		const setterDec1 = (
			fn: (this: Foo, x: undefined) => void,
			ctxSetter: ClassSetterDecoratorContext,
		) => {
			log.push("s2");
		...
		const staticSetterDec1 = (
			fn: (this: Foo, x: undefined) => void,
			ctxStaticSetter: ClassSetterDecoratorContext,
		) => {
			log.push("S2");
			if (
				!assertEq(
					() => typeof ctxStaticSetter.addInitializer,
					"function",
				)
			)
				return;
		...
		const staticAccessorDec1 = (
			...
			if (
				!assertEq(
					() => typeof ctxStaticAccessor.addInitializer,
					"function",
				)
			)
				return;
		...
		class Foo extends (log.push("extends"), Object) {
			...
			@getterDec1 @getterDec2 get getter(): undefined {
				return;
			}
			@staticGetterDec1 @staticGetterDec2 static get getter(): undefined {
				return;
			}

			@setterDec1 @setterDec2 set setter(x: undefined) {}
			@staticSetterDec1 @staticSetterDec2 static set setter(
				x: undefined,
			) {}
	...
	"Initializer order (public members, class expression)": () => {
		...
		// Setter decorators
		const setterDec1 = (
			fn: (this: Object, x: undefined) => void,
			ctxSetter: ClassSetterDecoratorContext,
		) => {
			log.push("s2");
			if (!assertEq(() => typeof ctxSetter.addInitializer, "function"))
	...
	"Initializer order (private members, class statement)": () => {
		...
		class Foo extends (log.push("extends"), Object) {
			...
			@staticGetterDec1
			@staticGetterDec2
			static get #staticGetter(): undefined {
				return;
			}

			@setterDec1 @setterDec2 set #setter(x: undefined) {}
			@staticSetterDec1 @staticSetterDec2 static set #staticSetter(
				x: undefined,
			) {}
			...
			@staticAccessorDec1
			@staticAccessorDec2
			static accessor #staticAccessor: undefined;
...
function assertThrows<T extends Function>(
	callback: () => void,
	expected: T,
): boolean {
	let details: string;
